...
const employeeSchema = new mongoose.Schema({
    employeeId: { type: String, required: true, maxlength: 50 },
...
function makeId(str) {
    ...
    if (str == "null") {
        ...
        tmpId = "EMP" + year.substring(2) + month + date + "C001";
    } else {
        // EMPYYMMDDC111
        str = str.split("C")
        ...
        if (date == idDate && month == idMonth && year == idYear) {
            ...
            tmpId = "EMP" + idYear + idMonth + idDate + "C" + tmp;
        } else {
            if (date != idDate && month == idMonth && year == idYear) {
                tmpId = "EMP" + idYear + idMonth + date + "C001";
            }
            if (month != idMonth && year == idYear) {
                tmpId = "EMP" + idYear + month + date + "C001";
            }
            if (year != idYear) {
                tmpId = "EMP" + year + month + date + "C001";
            }
        }
    }
    return tmpId;
