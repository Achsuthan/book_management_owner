    ...
    render() {
        ...
        return (
            <div style={{height:"100%", width:"100%", display:"flex", justifyContent:"center", alignItems:"center"}}>
                <div>
                    <div>
                        <input style={text} type="text" onChange={(e)=>{this.setState({username:e.target.value})}} placeholder="username" value={this.state.username}/>
                    </div>
                    <div>
                    ...
                    <div style={{color:"#03a9f4"}}><NavLink to="/register">Register</NavLink></div>
                </div>
