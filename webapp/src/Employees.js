    ...
    render() {
        return (
            <div style={{ padding: "20px" }}>
                <div>
                    <div style={{color:"white", backgroundColor:"#03a9f4", fontWeight:"bold",cursor:"pointer", padding:"10px",width:"200px", marginBottom:"20px"}} onClick={()=>{
                        ...
                        return (
                            <div style={{ backgroundColor:"white",display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr 1fr 1fr", gridTemplateRows:"30px", gridGap:"5px" }}>
                                ...
                                <div style={{cursor:"pointer"}} onClick={
                                    ()=>{
                                        let url=apiUrl+"employees/info/"+emp._id
                                        let options={
                                            method:"DELETE",
                                            url:url
